...
const styles = {
  note: {
    ...
    body: 'text-sky-800 [--tw-prose-background:theme(colors.sky.50)] prose-a:text-sky-900 prose-code:text-sky-900 dark:text-slate-300 dark:prose-code:text-slate-300 dark:[--tw-prose-bold:theme(colors.sky.400)]',
  },
  warning: {
    container:
